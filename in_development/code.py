...
if not lone_eye:
    ...
    bubble_display_1 = BubbleDisplay(units=1, digits=4, size = 1, center=(0.25, 0.25))
    test_display_group.append(bubble_display_1)

    bubble_display_2 = BubbleDisplay(units=1, digits=4, mode='Normal', size=1, center=(0.25, 0.5))
